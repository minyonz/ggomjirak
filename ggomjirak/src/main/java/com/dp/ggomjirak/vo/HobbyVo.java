...
//	private List<CompleteImgVo> completeImgs;
	...
	public HobbyVo(int hobby_no, String hobby_title, String hobby_writer, String main_img, int l_cate_no, int m_cate_no,
			int level_no, int cost_no, int time_no, int view_cnt, int like_cnt, String is_del, Timestamp reg_date) {
		super();
	...
	public String toString() {
		return "HobbyVo [hobby_no=" + hobby_no + ", hobby_title=" + hobby_title + ", hobby_writer=" + hobby_writer
				+ ", main_img=" + main_img + ", l_cate_no=" + l_cate_no + ", m_cate_no=" + m_cate_no + ", level_no="
				+ level_no + ", cost_no=" + cost_no + ", time_no=" + time_no + ", view_cnt=" + view_cnt + ", like_cnt="
				+ like_cnt + ", is_del=" + is_del + ", reg_date=" + reg_date + "]";
	}
