    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion green_background" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="/manager/managerHome">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>꼼지락 관리 현황</span></a>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">회원 정보 관리</h6>
                        <a class="collapse-item" href="/manager/managerMemberList">활동 회원 정보</a>
                        <a class="collapse-item" href="/manager/managerMemberListLeave">탈퇴 회원 정보</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Heading -->
            <div class="sidebar-heading">문의 & 이벤트</div>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
                        <i class="fa fa-bars green_color"></i>
                    </button>
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="회원 정보 검색"
                                aria-label="Search" aria-describedby="basic-addon2">
                            <div class="input-group-append">
                                <button class="btn btn-success green_background" type="button">
                                    <i class="fas fa-search fa-sm white_color"></i>
                                </button>
                            </div>
                        </div>
                    </form>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">${lo_user_id}</span>
