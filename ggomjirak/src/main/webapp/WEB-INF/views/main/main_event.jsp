	...
	$(".list").each(function() {
		$(this).click(function() {
			if ($(this).attr("id") == "listAll") {
				...
				var url = "/main/getEventListAll";
				
			} else if ($(this).attr("id") == "list") {
				$(".list").removeClass("active");
				$(this).addClass("active");
				var url = "/main/getEventList";
				
			} else if ($(this).attr("id") == "listEnd") {
				$(".list").removeClass("active");
				$(this).addClass("active");
				var url = "/main/getEventListEnd";
			...
			<div class="col-md-8">
				...
				<div class="container">
					...
					<ul class="nav nav-tabs">
						<li class="nav-item"><a id="listAll" class="nav-link list" href="#">전체 이벤트</a></li>
						<li class="nav-item"><a id="list" class="nav-link list active" href="#">진행중인 이벤트</a></li>
						<li class="nav-item"><a id="listEnd" class="nav-link list" href="#">종료된 이벤트</a></li>
					</ul>
				</div>
