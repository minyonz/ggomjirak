...
<meta name="user_id" content='11218161' />
...
<link rel="stylesheet" type="text/css" href="https://recipe1.ezmember.co.kr/static/css/bootstrap_20210310.css" />
<link rel="stylesheet" type="text/css" href="https://recipe1.ezmember.co.kr/static/css/font_20200413.css" />
<link rel="stylesheet" type="text/css" href="https://recipe1.ezmember.co.kr/static/css/font-awesome.min.css" />
<link rel="stylesheet" type="text/css" href="https://recipe1.ezmember.co.kr/static/css/ez_recipe_20210608.css" />
...
var _CURRENT_PAGE_ = 'https://www.10000recipe.com/inbox/insert.html';
var _USER_ID_ = '11218161';
</script>
...
<script>
  ...
  googletag.cmd.push(function() {
    ...
    <script>
        ...
        })(document, 'script', '10086');
    </script>
    <!-- datarize script -->
    <!-- bigin script -->
    <script>(function (w, d, s, l, i, c) {var f = d.getElementsByTagName(s)[0], j = d.createElement(s); j.async = true; j.src = 'https://sdk.bigin.io/v1/bigin.sdk.js'; var u = navigator.userAgent.toLowerCase(), h = {projectID: i, currencyCode: c}; if ((u.indexOf('msie') !== -1) && parseInt(u.split('msie')[1]) < 9) { var r = setInterval(function () { if (w[l] !== undefined) { clearInterval(r); w[l].config(h); } }, 50); } else { j.onload = function () { w[l].config(h) }; } f.parentNode.insertBefore(j, f); })(window, document, 'script', 'bigin', '3UTI5WW7SZ-5', 'KRW'); </script>
    <script>
        $(function () {
            var id = "11218161";
            var name = "하윤지";
            var email = "hawing09@naver.com";
            ...
            $(document).on('click','.LgGoodsItem', function () {
                ...
                var item = {
                    ...
                    list : $(this).closest('.LgGoodsItemList').data('list'),
                    position : $(this).data('position') + 1,
                    brand : "",
                }
                                try {
                    bigin.event("bg:impression", item)
                } catch (e) {}
...
<body>
	...
	<a href="#" id="btnGogoTop" class="rmenu_top" style="display: block;"><span class="glyphicon glyphicon-menu-up"></span></a>
	...
	</div><!-- /.modal --><link rel="stylesheet" type="text/css" href="https://recipe1.ezmember.co.kr/static/css/jquery-ui-1.11.4_201507011.css">
	<style>
	.tagit {
	...
	function delMainPhoto(){
		...
		if ($("#cok_reg_type").val() == 'edit') {
			$("#divMainPhotoBox").html('<img id="mainPhotoHolder" onclick="browseMainFile()" src="https://recipe1.ezmember.co.kr/img/pic_none.gif" style="width: 170px; height: 170px; cursor:pointer">');
			$("#main_copy_image").remove();
		} else {
			$("#divMainPhotoBox").html('<img id="mainPhotoHolder" onclick="browseMainFile()" src="https://recipe1.ezmember.co.kr/img/pic_none4.gif" style="width: 250px; height: 250px; cursor:pointer">');
			$("#main_copy_image").remove();
		}
	}
	...
	function delVideoPhoto(){
		...
		$("#cok_video_src").val('');
		if ($("#cok_reg_type").val() == 'edit') {
			$("#divVideoPhotoBox").html('<img id="videoPhotoHolder" src="https://recipe1.ezmember.co.kr/img/pic_none5.gif" style="width: 178px; height: 100px;">');
		} else {
			$("#divVideoPhotoBox").html('<img id="videoPhotoHolder" src="https://recipe1.ezmember.co.kr/img/pic_none5.gif" style="width: 178px; height: 100px;">');
		}
	}
	...
	function delStepPhoto(step){
		...
		$("#divStepArea [id=divStepPhotoBox_" + step + "]").html('<img id="stepPhotoHolder_' + step + '" onclick="browseStepFile(' + step + ')" src="https://recipe1.ezmember.co.kr/img/pic_none2.gif" alt="No Image" style="width: 160px; height: 160px; cursor:pointer">');
	}
	...
	function delWorkPhoto(step){
		...
		$("#divWorkArea [id=divWorkPhotoBox_" + step + "]").html('<img id="workPhotoHolder_' + step + '" onclick="browseWorkFile(' + step + ')" src="https://recipe1.ezmember.co.kr/img/pic_none3.gif" alt="No Image" style="width: 140px; height: 140px; cursor:pointer">');
	}
	...
	<input type="hidden" name="cok_reg_id" id="cok_reg_id" value="11218161">
	...
	<link rel="stylesheet" type="text/css" href="https://recipe1.ezmember.co.kr/static/css/jquery.tagit.css"><style>
	...
	<div class="container recipe_regi">
		...
		<div class="regi_title">레시피 등록
			<div class="tit_right">
							<a href="javascript:openStepGuide();"><img src="https://recipe1.ezmember.co.kr/img/btn_tip.gif" alt="단계별 추가 정보 입력 안내"></a>
				<a href="javascript:void(0)" id="btnRecipeIdGuide"><img src="https://recipe1.ezmember.co.kr/img/btn_id2.gif" alt="레시피ID활용안내"></a>
				<a href="javascript:void(0)" id="btnRecipeInsertGuide"><img src="https://recipe1.ezmember.co.kr/img/btn_guide.gif" alt="레시피등록안내"></a>
			</div>
		</div>
	...
	<option value="5">신의경지</option>
		...
		<div class="cont_box pad_l_60">
		  ...
		  <div id="divStepArea" class="ui-sortable"><div id="divStepItem_1" class="step">
			  ...
			  <div style="padding:5px;">
				  <a href="javascript:void(0);" id="stepBtn_material_1" class="btn btn-xs btn-default" style="width:70px;height:26px;"><img src="https://recipe1.ezmember.co.kr/img/mobile/app_icon_step_material.png" style="width:16px;height:16px;"> 재료</a>
				  <a href="javascript:void(0);" id="stepBtn_cooker_1" class="btn btn-xs btn-default" style="width:70px;height:26px;"><img src="https://recipe1.ezmember.co.kr/img/mobile/app_icon_step_tool.png?v.1" style="width:16px;height:16px;"> 도구</a>
				  <a href="javascript:void(0);" id="stepBtn_fire_1" class="btn btn-xs btn-default" style="width:70px;height:26px;"><img src="https://recipe1.ezmember.co.kr/img/mobile/app_icon_step_fire.png?v.1" style="width:16px;height:16px;"> 불</a>
				  <a href="javascript:void(0);" id="stepBtn_tip_1" class="btn btn-xs btn-default" style="width:70px;height:26px;"><img src="https://recipe1.ezmember.co.kr/img/mobile/app_icon_step_tip.png?v.1" style="width:16px;height:16px;"> 팁</a>
								<a href="javascript:void(0);" id="stepBtn_all_1" class="btn btn-xs btn-default" style="width:70px;height:26px;"> 전 체 </a>
				  <a href="javascript:openStepGuide();" id="stepBtn_guide_1" class="btn btn-xs btn-default" style="width:160px;height:26px; border:none; background:#4f9a13; color:#fff; padding:6px 7px 4px;">추가기능을 넣어보세요!!</a>

				  <div id="stepForm_material_1" style="display:none;margin:5px 5px;"><img src="https://recipe1.ezmember.co.kr/img/mobile/app_icon_step_material.png" style="width:24px;height:24px;"> <input type="text" name="step_material[]" id="step_material_1" placeholder="밀가루 100g,소금 2큰술,물 100g" class="form-control step_cont" style="width:500px;height:24px;"></div>
				  <div id="stepForm_cooker_1" style="display:none;margin:5px 5px;"><img src="https://recipe1.ezmember.co.kr/img/mobile/app_icon_step_tool.png?v.1" style="width:24px;height:24px;"> <input type="text" name="step_cooker[]" id="step_cooker_1" placeholder="국자,볼" class="form-control step_cont" style="width:500px;height:24px;"></div>
				  <div id="stepForm_fire_1" style="display:none;margin:5px 5px;"><img src="https://recipe1.ezmember.co.kr/img/mobile/app_icon_step_fire.png?v.1" style="width:24px;height:24px;"> <input type="text" name="step_fire[]" id="step_fire_1" placeholder="약불" class="form-control step_cont" style="width:500px;height:24px;"></div>
				  <div id="stepForm_tip_1" style="display:none;margin:5px 5px;"><img src="https://recipe1.ezmember.co.kr/img/mobile/app_icon_step_tip.png?v.1" style="width:24px;height:24px;vertical-align:top;"> <textarea name="step_tip[]" id="step_tip_1" class="form-control step_cont" style="width:500px;height:50px;resize:none;"></textarea></div>
				  <div id="stepForm_video_1" style="display:none;margin:5px 5px;"><img src="https://recipe1.ezmember.co.kr/img/mobile/app_icon_step_video.png" style="width:24px;height:24px;"> <input type="text" name="step_video[]" id="step_video_1" placeholder="양파 다듬는 법" class="form-control step_cont" style="width:380px;height:24px;">
							<input type="text" name="step_video_seq[]" id="step_video_seq_1" placeholder="6816284" class="form-control step_cont" style="width:100px;height:24px;"></div>
			  </div>
				</div>
		...
		<input type="hidden" name="boa_tx_tag" value="" id="mySingleFieldTags" style="width:100%" class="tagit-hidden-field"><ul class="tagit ui-widget ui-widget-content ui-corner-all"><li class="tagit-new"><input type="text" class="ui-widget-content ui-autocomplete-input" autocomplete="off"></li></ul>
	...
	[양념] 고춧가루 2T, 진간장 1T, 참치액 1T, 참기름 1T, 매실액 1T, 통깨 " style="height:120px; width:620px; resize:none;" group_idx=""></textarea>
				...
				<p style="text-align:center; padding:0 0 20px 0"><img src="https://recipe1.ezmember.co.kr/img/img_use.gif"></p>
			</div>
		</div>
	</div>
		...
		<div class="modal-dialog" style="width:1000px;">
			<div class="modal-content" style="padding:0;">
				...
				<div class="modal-body" style="padding:0;">
					<div class="guide_tit"><img src="https://recipe1.ezmember.co.kr/img/guide_tt2.gif"></div>
					<div class="modal_guide st2">
						...
						<p class="list">글 작성 시에 <b>'@'뒤에 레시피ID</b>를 붙이면 해당 레시피 링크가 생성됩니다.<br>
							<img src="https://recipe1.ezmember.co.kr/img/guide4_01.jpg">
						</p>
						<p class="list">복사(Ctrl+C) 후 원하는 곳에 붙여넣기(Ctrl+V)하세요.<br>
							<img src="https://recipe1.ezmember.co.kr/img/guide4_02.jpg"></p>
					</div>
	...
	<div id="recipeInsertGuideModal" class="modal fade">
		<div class="modal-dialog" style="width:1000px">
			<div class="modal-content new_folder">
				...
				<div class="modal-body" style="padding:0;">
					<div class="guide_tit"><img src="https://recipe1.ezmember.co.kr/img/guide_tt.gif"></div>
					<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
						<div class="panel panel-default">
							...
							<div id="collapseOne" class="panel-collapse collapse out" role="tabpanel" aria-labelledby="headingOne">
								<div class="panel-body" style="border-top:1px solid #e6e7e8;">
									<img src="https://recipe1.ezmember.co.kr/img/guide1_01.jpg">
									<br>
									<img src="https://recipe1.ezmember.co.kr/img/guide1_02.jpg">
									<br>
									<img src="https://recipe1.ezmember.co.kr/img/guide1_03.jpg">
								</div>
							</div>
						</div>
						<!--/panel panel-default -->
						...
						<div class="panel panel-default">
							...
							<div id="collapseThree" class="panel-collapse collapse out" role="tabpanel" aria-labelledby="headingThree">
								<div class="panel-body" style="border-top:1px solid #e6e7e8;">
									<img src="https://recipe1.ezmember.co.kr/img/guide3_01.jpg">
									<br>
									<img src="https://recipe1.ezmember.co.kr/img/guide3_02.jpg">
									<br>
									<img src="https://recipe1.ezmember.co.kr/img/guide3_03.jpg">
								</div>
							</div>
						</div>
						<!--/panel panel-default -->
	...
	<script type="text/javascript" id="">!function(b,e,f,g,a,c,d){b.fbq||(a=b.fbq=function(){a.callMethod?a.callMethod.apply(a,arguments):a.queue.push(arguments)},b._fbq||(b._fbq=a),a.push=a,a.loaded=!0,a.version="2.0",a.queue=[],c=e.createElement(f),c.async=!0,c.src=g,d=e.getElementsByTagName(f)[0],d.parentNode.insertBefore(c,d))}(window,document,"script","https://connect.facebook.net/en_US/fbevents.js");fbq("init","2162540197189035");</script>
	<noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=2162540197189035&amp;ev=PageView&amp;noscript=1"></noscript>
	<script>
	var curVRPage = 1;
	var totalVRcnt = 0;
